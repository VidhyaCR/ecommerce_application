...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'confirm_password' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2024-03-26 11:57:31',
                'modified' => '2024-03-26 11:57:31',
            ],
        ];
        parent::init();
    }
