  ...
  <div class="panel-heading">  <h4 >User Profile</h4></div>
   <div class="panel-body">
    ...
    <div class="box box-info">
            ...
            <div class="box-body">
                     <div class="col-sm-6">
                     <div  align="center"> <img alt="User Pic" src="https://www.terrainhopperusa.com/wp-content/uploads/2019/01/avatar-man.png" id="profile-image1" class="img-circle img-responsive"> 
...
<div class="col-sm-5 col-xs-6 tital " >Name:</div><div class="col-sm-7 col-xs-6 "><?= h($user->name) ?></div>
     <div class="clearfix"></div>
